...
public class BankSystemModelConfiguration : ModelConfiguration
{
    public BankSystemModelConfiguration()
    {
        
    }
    public BankSystemModelConfiguration(bool initializeAccess) : base(initializeAccess)
    {
    }
