...
- Added methods that injects passed `ServiceProvider`.
- Added extension method `Join()` for `ServiceCollection`. It combines several `ServiceCollection` instances in one.
